...
```{r topo_snapshot, echo = FALSE, warning = FALSE}
Sys.sleep(0.2)
...
```{r feature_map_snapshot, echo = FALSE, warning = FALSE}
Sys.sleep(0.2)
# add compass
rayshader::render_compass(position = "W", compass_radius = 50)
rayshader::render_snapshot()
...
```{r}
if(file.exists("../data/topo.tif") == TRUE & overwrite_it == FALSE){
  topo <- stars::read_stars("../data/topo.tif")
}else{
